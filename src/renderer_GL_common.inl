...
#ifndef SDL_GPU_renderer_GL_common__
#define SDL_GPU_renderer_GL_common__
...
{
#if defined(SDL_GPU_USE_OPENGL) && !defined(SDL_GPU_DISABLE_GLEW)
...
static void SetShaderImage(GPU_Renderer* renderer,
    GPU_Image* image, int location, int image_unit)
{
